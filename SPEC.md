...
block indented four columns after a blank line — is not a verdict, exactly
as a URL in code is not a citation (§6, `milestone evidence`). Those are
the shapes a form quoted from a contract and an earlier verdict shown
verbatim take.
