...
3. **Human gates** — pre-marked ask-the-human points plus ad-hoc
   ...
   task to carry it: it is raised on the milestone issue, where nothing
   mechanical blocks on the label — `status` lists the gate beside the
   tasks' gates instead, marked (#200).
